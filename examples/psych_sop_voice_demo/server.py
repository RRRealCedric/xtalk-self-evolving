...
from xtalk.serving.module_types import LLMAgentContextManager, PsychSOPManager  # noqa: E402
...
app.mount("/static", StaticFiles(directory=str(example_server_path / "static")), name="static")
try:
    app.mount(
        "/xtalk",
        StaticFiles(
